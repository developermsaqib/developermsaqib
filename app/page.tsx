...
export default function DarkPortfolio() {
  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive enterprise claims management system featuring real-time data synchronization, multi-channel communication (email, SMS, Slack), automated workflows with cron jobs, AWS S3 integration for document storage, and WebSocket support for live updates",
      image:
    ...
    {
      title: "Producer/Consumer Platform",
      category: "Backend Development",
      description:
        "Enterprise claims management system with real-time data synchronization via Redis, AWS SQS message queuing, automated document processing with Puppeteer, and AWS S3 integration. Built with Node.js, Express, and MongoDB for scalable, asynchronous claim processing.",
      image:
    ...
    {
      title: "Stansted Parking — Booking & Checkout Platform",
      category: "Full-Stack Web App",
      description:
        "Full parking reservation system for Stansted Airport using Next.js (App Router) and TypeScript. Features booking search, dynamic pricing, an admin panel, Stripe payments with webhooks, SendGrid emails, and a Prisma + PostgreSQL backend, with clean server/client actions and reusable components.",
      image:
    ...
    },
    {
      ...
      description:
        "Track workouts and nutrition with personalized recommendations",
      image:
  ...
  return (
    <div className="bg-gray-950 text-gray-100 min-h-screen">
      ...
      <section
        id="home"
        className="min-h-96 flex items-center justify-center relative overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="#portfolio"
              className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all duration-300 flex items-center gap-2"
            >
              View Work <ArrowRight size={20} />
            </a>
            <a
              href="#contact"
              className="px-8 py-3 bg-gray-800 border border-gray-700 rounded-full font-semibold hover:bg-gray-700 transition-all duration-300"
            >
              Get In Touch
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-400 leading-relaxed">
                <p>
                  I&apos;m a passionate developer with a keen eye for design and
                  a love for creating seamless digital experiences. With years
                  of experience in web and mobile development, I bring ideas to
                  life through clean code and intuitive interfaces.
                </p>
                <p>
                  My approach combines technical expertise with creative
                  problem-solving, ensuring every project not only meets but
                  exceeds expectations. I specialize in modern frameworks and
                  love staying at the forefront of technology.
                </p>
                <p>
              ...
              <div className="mt-8 flex gap-4">
                ...
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all duration-300"
                >
                  <Mail size={20} />
                </a>
              </div>
